...
_SYSTEM_PROMPT = (
    ...
    "部門別の荒利率変化を指摘する際は、pt（ポイント）の変化幅の大きさだけで判断せず、"
    "各部門に併記されている「影響額」（売上規模を考慮した概算の利益インパクト）を根拠に、"
    "全体の利益への影響が大きい部門を優先して現状分析・改善施策に取り上げてください。"
    "売上が小さく影響額も小さい部門を主要因であるかのように書かないでください。"
